...
public class Bank {
	...
	static String MIND_DIR_NAME = "Mind";
	...
	private void createDirectories() {
		...
		mindDirPath = createDirectory(path, MIND_DIR_NAME);
	...
	public int[] moveToMind(int[] values, String tag,String[] newpans) {
		int[] failed;

		ArrayList<IncomeFile> bankFiles = selectAllFileNamesFolder(bankDirPath, "bank");
		ArrayList<IncomeFile> frackedFiles = selectAllFileNamesFolder(bankDirPath, "fracked");
		ArrayList<CloudCoin> mindCoins = new ArrayList<>();
